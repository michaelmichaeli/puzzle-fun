...
export const PuzzleSolver: React.FC<PuzzleSolverProps> = ({
  ...
  return (
    <div
      className="space-y-4 relative w-full max-w-full p-4 overflow-hidden"
      role="application"
    ...
    >
      ...
      <div
        id="puzzle-board"
        className="relative w-full h-[calc(100vh-8rem)] bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl overflow-hidden shadow-xl mx-auto focus:outline-none focus:ring-2 focus:ring-primary"
        style={{
          touchAction: "none",
          maxWidth: "100vw",
          minWidth: "100%",
